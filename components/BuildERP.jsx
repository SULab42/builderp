...
function useSheetData(sheetName, mockData) {
  ...
  return { data, syncing, add, reload: load };
}
      ...
      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(290px,1fr))",gap:14}}>
        {data.projects.map(p=>(
          <Card key={p.id}>
            ...
            <div style={{borderTop:"1px solid #1e293b",marginTop:10,paddingTop:10,display:"flex",justifyContent:"space-between",fontSize:12}}>
    ...
    <div style={{display:"flex",height:"100vh",background:"#070f1c",fontFamily:"'Sarabun',sans-serif",overflow:"hidden"}}>
      ...
      <div style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden"}}>
        ...
        <div style={{flex:1,overflow:"auto",padding:18,paddingBottom:80}}>
          ...
          {tab==="projects"  && <Projects data={data} onAdd={item=>projectsSheet.add(item)}/>}
          {tab==="tasks"     && <Tasks data={data} onAdd={item=>tasksSheet.add(item)}/>}
